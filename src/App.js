        ...
        {page === 'dashboard' && (
          <div>
            ...
            <div className="summary-grid">
              <div className="sum-card accent"><div className="sum-label">Today Litres</div><div className="sum-value">{todayE.reduce((s,e)=>s+e.qty,0).toFixed(2)} L</div><div className="sum-sub">{todayE.length} session(s)</div></div>
              <div className="sum-card accent"><div className="sum-label">Today Amount</div><div className="sum-value">Rs.{todayE.reduce((s,e)=>s+(e.amount||0),0).toFixed(2)}</div><div className="sum-sub">Income</div></div>
              <div className="sum-card"><div className="sum-label">Month Litres</div><div className="sum-value">{monthE.reduce((s,e)=>s+e.qty,0).toFixed(2)} L</div><div className="sum-sub">{monthE.length} entries</div></div>
              <div className="sum-card"><div className="sum-label">Month Income</div><div className="sum-value">Rs.{monthE.reduce((s,e)=>s+(e.amount||0),0).toFixed(2)}</div><div className="sum-sub">Gross</div></div>
            </div>
            <div className="section-title syne">Recent Entries</div>
            <div className="table-wrap">
              <table>
                <thead><tr><th>Date</th><th>Session</th><th>Farmer</th><th>Qty</th><th>Amt</th></tr></thead>
                <tbody>
                  ...
                  {!entries.length && <tr><td colSpan="5"><div className="empty">No entries yet</div></td></tr>}
                </tbody>
              </table>
            </div>
          </div>
        ...
        {page === 'log' && (
          <div>
            <div className="card sms-card">
              ...
              {parsedPreview && (
                <div className="preview-box">
                  ...
                  <div className="preview-row"><span>Amount</span><b>Rs.{parsedPreview.amount}</b></div>
            ...
            <div className="table-wrap">
              ...
              <table>
                <thead><tr><th>Date</th><th>Session</th><th>Farmer</th><th>Qty</th><th>Fat</th><th>SNF</th><th>Amt</th><th></th></tr></thead>
                <tbody>
        ...
        {page === 'profit' && (
          <div>
            ...
            <div className="table-wrap">
              ...
              <table>
                <thead><tr><th>Month</th><th>Income</th><th>Expenses</th><th>Profit</th><th>Litres</th></tr></thead>
                <tbody>
                  {getAllMonths().map(m => {
