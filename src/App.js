...
export default function App() {
  ...
  // payment SMS state kept for drive sync compatibility
  const [paymentSmsText, setPaymentSmsText] = useState(''); // eslint-disable-line
  const [parsedPaymentPreview, setParsedPaymentPreview] = useState(null); // eslint-disable-line
